$(document).ready(function() {
  ...
  function checkHeadingVisibility() {
    ...
    if (isInViewport($('#heading1'))) {
      image.attr('src', 'images/rc-home-hro-01.png');  // Change to Image 1
    } else if (isInViewport($('#heading2'))) {    
      image.attr('src', 'images/rc-home-hro-02.png');  // Change to Image 2
    } else if (isInViewport($('#heading3'))) {
      image.attr('src', 'images/rc-home-hro-03.png');  // Change to Image 3
    }
  }
