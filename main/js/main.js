!(function (t) {
    ...
    if (
        ...
        document.querySelectorAll(".instafeed-wrapper").forEach(function (e, a) {
            var o = "IGQVJVTy1HeXQ4TkVuLW5tYXNyTGt1dUJLM24tWHBBVFZA0U1BTQWxWald2ODNtVmVjVFB3QkdCSHpBWFBTZAWc4MlZAJaEdsRElwV1FkLUt0Ml9WbXlDOUZAGOGk3YlI5WTZAwRXBYWDVzeE1RWUtlRndjXwZDZD",
                i = t(e),
    ...
    function D() {
        ...
        e >= 200 &&
            ...
            e > 150 ? (t(".scroll-top-arrow").fadeIn("300"), !t(".show-theme-demos").length && N() > 1199 && t(".theme-demos").fadeIn("300")) : t(".scroll-top-arrow").fadeOut("300");
    }
    function j(e) {
    ...
    function H() {
        (t(".overlap-section").length > 0 || t(".overlap-section-one-fourth").length > 0 || t(".overlap-section-three-fourth").length > 0) && N() >= 768
